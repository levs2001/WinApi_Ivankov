///TODO: Дописать комменты, как сказали в лекции
/// Сделать так, чтобы при смене режимов с версткой и без, первый выводимый символ оставался
/// тем же
/// На компе xp не билдится, не находится какой-то библиотеки
